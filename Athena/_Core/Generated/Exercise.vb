Namespace Core
	...
	''' <generator-date>03/02/2014 13:08:16</generator-date>
	''' <generator-functions>1</generator-functions>
	''' <generator-source>Athena\Athena\_Core\Generated\Exercise.tt</generator-source>
	''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
	''' <generator-version>1</generator-version>
	<System.CodeDom.Compiler.GeneratedCode("Athena\Athena\_Core\Generated\Exercise.tt", "1")> _
	...
	Partial Public Class Exercise
		...
		#Region " Class Plumbing/Interface Code "
			...
			#Region " IComparable Implementation "
				...
				#Region " Public Methods "
					...
					Public Overridable Function IComparable_CompareTo( _
						...
						Dim typed_Value As Exercise = TryCast(value, Exercise)
			...
			#Region " DbRetrievable Implementation "
				...
				Public Class All
					Implements System.Collections.Generic.IEnumerable(Of Exercise)
					Implements System.Collections.Generic.IEnumerator(Of Exercise)
					...
					#Region " Private Variables "
						...
						''' <summary></summary>
						''' <remarks></remarks>
						Private IDX_EXERCISE_ID As System.Int32 = -1

						''' <summary></summary>
						''' <remarks></remarks>
						Private IDX_EXERCISE_CODE As System.Int32 = -1

						''' <summary></summary>
						''' <remarks></remarks>
						Private IDX_EXERCISE_NAME As System.Int32 = -1

						''' <summary></summary>
						''' <remarks></remarks>
						Private IDX_EXERCISE_CREATED As System.Int32 = -1
					...
					#Region " Protected Methods "
						...
						Protected Function Hydrate( _
							...
							Return Hydrate(New Exercise(), reader)

						End Function

						Protected Function Hydrate( _
							ByRef value As Exercise, _
							ByVal reader As System.Data.IDataReader _
						) As Exercise

							If Not reader.IsDBNull(IDX_EXERCISE_ID) Then _
								value.m_Id = reader.GetInt32(IDX_EXERCISE_ID)
							If Not reader.IsDBNull(IDX_EXERCISE_CODE) Then _
								value.Code = reader.GetString(IDX_EXERCISE_CODE)
							If Not reader.IsDBNull(IDX_EXERCISE_NAME) Then _
								value.Name = reader.GetString(IDX_EXERCISE_NAME)
							If Not reader.IsDBNull(IDX_EXERCISE_CREATED) Then _
								value.Created = reader.GetDateTime(IDX_EXERCISE_CREATED)
							Return value
					...
					#Region " IEnumerator Implementation "
						...
						Private ReadOnly Property GetCurrent_Typed() As Exercise Implements IEnumerator(Of Exercise).Current
							Get
								Return Cur
							End Get
						End Property

						Private Function MoveNext() As Boolean Implements IEnumerator(Of Exercise).MoveNext
						...
						Private Sub Reset() Implements IEnumerator(Of Exercise).Reset
							...
							IDX_EXERCISE_ID = rdr.GetOrdinal("Exercise_Id")
							If IDX_EXERCISE_ID < 0 Then Throw New Exception("Mapping For Field Not Correct: Exercise_Id")

							IDX_EXERCISE_CODE = rdr.GetOrdinal("Exercise_Code")
							If IDX_EXERCISE_CODE < 0 Then Throw New Exception("Mapping For Field Not Correct: Exercise_Code")

							IDX_EXERCISE_NAME = rdr.GetOrdinal("Exercise_Name")
							If IDX_EXERCISE_NAME < 0 Then Throw New Exception("Mapping For Field Not Correct: Exercise_Name")

							IDX_EXERCISE_CREATED = rdr.GetOrdinal("Exercise_Created")
							If IDX_EXERCISE_CREATED < 0 Then Throw New Exception("Mapping For Field Not Correct: Exercise_Created")
					...
					#Region " IEnumerable Implementation "
						...
						Private Function GetEnumerator As IEnumerator(Of Exercise) Implements IEnumerable(Of Exercise).GetEnumerator
					...
					#Region " IDisposable Implementation "
						...
						Private Sub Dispose() Implements IEnumerator(Of Exercise).Dispose
					...
					#Region " ITypedList Implementation "
						...
						Implements System.ComponentModel.ITypedList.GetItemProperties
							...
							Return System.ComponentModel.TypeDescriptor.GetProperties(GetType(Exercise))
						...
						Implements System.ComponentModel.ITypedList.GetListName
							...
							Return "Enumerable Collection of Exercise"
						...
						Protected Friend Shared Function [Select]( _
							...
							#Region " Public Shared Enumeration Methods "
								...
								Public Shared Function [Get]( _
									...
									Return [Get](connection, "tbl_Core_Exercises")
								...
								Public Shared Function Filter( _
									...
									If (fields And 1) = 1 Then
										...
										parameter_Names.Append("(Exercise_Id = ")
									...
									If (fields And 2) = 2 Then
										...
										If Not String.IsNullOrEmpty(CType(values(value_Index), System.String)) AndAlso CType(values(value_Index), System.String).Contains("*") Then
											parameter_Names.Append("(Exercise_Code LIKE ")
										...
										Else
											parameter_Names.Append("(Exercise_Code = ")
										End If
										If connection.GetType Is GetType(System.Data.OleDb.OleDbConnection) Then
											parameter_Names.Append("?)")
										Else
									...
									If (fields And 4) = 4 Then
										If parameter_Names.Length > 0 Then parameter_Names.Append(condition_Operator)
										If Not String.IsNullOrEmpty(CType(values(value_Index), System.String)) AndAlso CType(values(value_Index), System.String).Contains("*") Then
											parameter_Names.Append("(Exercise_Name LIKE ")
											If connection.GetType Is GetType(System.Data.SqlClient.SqlConnection) Then values(value_Index) = CStr(values(value_Index)).Replace("*", "%") Else _
												values(value_Index) = CStr(values(value_Index)).Replace("*", "")
										Else
											parameter_Names.Append("(Exercise_Name = ")
										End If
										If connection.GetType Is GetType(System.Data.OleDb.OleDbConnection) Then
											parameter_Names.Append("?)")
										Else
									...
									If (fields And 8) = 8 Then
										If parameter_Names.Length > 0 Then parameter_Names.Append(condition_Operator)
										parameter_Names.Append("(Exercise_Created = ")
										If connection.GetType Is GetType(System.Data.OleDb.OleDbConnection) Then
											parameter_Names.Append("?)")
										Else
									...
									Return [Select](connection, String.Format("SELECT * FROM {0} WHERE (" & parameter_Names.ToString() & ")", "tbl_Core_Exercises"), _
							...
							#Region " Public Shared Manipulation Methods "
								...
								Public Shared Function [Set]( _
									...
									Return [Set](connection, value, "tbl_Core_Exercises")
								...
								Public Shared Function [Set]( _
									...
									If value.DbRetrievable_ValidateForSet Then
										...
										If connection.GetType Is GetType(System.Data.OleDb.OleDbConnection) Then
											...
											If insert_New Then
												OLEDB_Proc = String.Format("INSERT INTO {0} (Exercise_Code, Exercise_Name, Exercise_Created) VALUES (?, ?, ?)", tableName)
											Else
												OLEDB_Proc = String.Format("UPDATE {0} SET Exercise_Code = ?, Exercise_Name = ?, Exercise_Created = ? WHERE (Exercise_Id = ?)", tableName)
											End If
										...
										ElseIf connection.GetType Is GetType(System.Data.SqlClient.SqlConnection) Then
											...
											If insert_New Then
												SQL_Proc = String.Format("INSERT INTO {0} (Exercise_Code, Exercise_Name, Exercise_Created) VALUES (@Code, @Name, @Created); SELECT @Id = SCOPE_IDENTITY();", tableName)
											Else
												SQL_Proc = String.Format("UPDATE {0} SET Exercise_Code = @Code, Exercise_Name = @Name, Exercise_Created = @Created WHERE (Exercise_Id = @Id)", tableName)
											End If
								...
								Public Shared Function [Create]( _
									...
									Return [Create](connection, _code, _name, _created, "tbl_Core_Exercises")
								...
								Public Shared Function [Create]( _
									...
									If value.DbRetrievable_ValidateForSet Then
										...
										If connection.GetType Is GetType(System.Data.OleDb.OleDbConnection) Then
											...
											Dim OLEDB_Comm As New System.Data.OleDb.OleDbCommand(String.Format("INSERT INTO {0} (Exercise_Code, Exercise_Name, Exercise_Created) VALUES (?, ?, ?)", tableName), CType(connection, System.Data.OleDb.OleDbConnection))
											OLEDB_Comm.CommandType = System.Data.CommandType.Text
										...
										ElseIf connection.GetType Is GetType(System.Data.SqlClient.SqlConnection) Then
											...
											Dim SQL_Comm As New System.Data.SqlClient.SqlCommand(String.Format("INSERT INTO {0} (Exercise_Code, Exercise_Name, Exercise_Created) VALUES (@Code, @Name, @Created); SELECT @Id = SCOPE_IDENTITY();", tableName), CType(connection, System.Data.SqlClient.SqlConnection))
											SQL_Comm.CommandType = System.Data.CommandType.Text

											Dim param_1 As System.Data.SqlClient.SqlParameter
											param_1 = New System.Data.SqlClient.SqlParameter("@Code", value.Code)
											SQL_Comm.Parameters.Add(param_1)

											Dim param_2 As System.Data.SqlClient.SqlParameter
											param_2 = New System.Data.SqlClient.SqlParameter("@Name", value.Name)
											SQL_Comm.Parameters.Add(param_2)
							...
							#Region " Public Shared Identity Methods "
								...
								Public Shared Function [One]( _
									...
									Return [One](connection, value, "tbl_Core_Exercises")
								...
								Public Shared Function [One]( _
									...
									Return [One](connection, id, "tbl_Core_Exercises")
								...
								Public Shared Function [One]( _
									...
									If connection.GetType Is GetType(System.Data.OleDb.OleDbConnection) Then
										...
										Return System.Linq.Enumerable.FirstOrDefault([Select](connection, _
											String.Format("SELECT * FROM {0} WHERE (Exercise_Id = ?)", viewName), _
											New System.Collections.Generic.KeyValuePair(Of System.String, System.Object)("Id", id)))

									Else

										Return System.Linq.Enumerable.FirstOrDefault([Select](connection, _
											String.Format("SELECT * FROM {0} WHERE (Exercise_Id = @Id)", viewName), _
											New System.Collections.Generic.KeyValuePair(Of System.String, System.Object)("Id", id)))
								...
								Public Shared Function [Delete]( _
									...
									Return [Delete](connection, value, "tbl_Core_Exercises")
								...
								Public Shared Function [Delete]( _
									...
									Return [Delete](connection, id, "tbl_Core_Exercises")
								...
								Public Shared Function [Delete]( _
									...
									If connection.GetType Is GetType(System.Data.OleDb.OleDbConnection) Then
										...
										Dim OLEDB_Proc As String = String.Format("DELETE FROM {0} WHERE (Exercise_Id = ?)", tableName)
									...
									ElseIf connection.GetType Is GetType(System.Data.SqlClient.SqlConnection) Then
										...
										Dim SQL_Proc As String = String.Format("DELETE FROM {0} WHERE (Exercise_Id = @Id)", tableName)
