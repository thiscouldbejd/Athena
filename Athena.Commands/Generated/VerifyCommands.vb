...
''' <generator-date>08/02/2014 17:30:47</generator-date>
''' <generator-functions>1</generator-functions>
''' <generator-source>Athena\Athena.Commands\Generated\VerifyCommands.tt</generator-source>
''' <generator-template>Text-Templates\Classes\VB_Object.tt</generator-template>
''' <generator-version>1</generator-version>
<System.CodeDom.Compiler.GeneratedCode("Athena\Athena.Commands\Generated\VerifyCommands.tt", "1")> _
<Leviathan.Commands.Command(ResourceContainingType:=GetType(VerifyCommands), ResourceName:="CommandDetails", Name:="athena-verify", Description:="Athena Verification Commands", Hidden:=False)> _
Partial Public Class VerifyCommands
	...
	#Region " Public Properties "
		...
		''' <remarks></remarks>
		<Leviathan.Configuration.Configurable("athena-source", ResourceContainingType:=GetType(VerifyCommands), ResourceName:="CommandDetails", Description:="Athena Data Source", ArgsDescription:="<data source", Prefix:="/")> _
