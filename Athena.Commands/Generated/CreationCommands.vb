...
''' <generator-date>21/01/2015 21:03:42</generator-date>
...
Partial Public Class CreationCommands
	...
	#Region " Public Properties "
		...
		''' <remarks></remarks>
		<Leviathan.Configuration.Configurable("mail-server-validate-certificate", ResourceContainingType:=GetType(CreationCommands), ResourceName:="CommandDetails", Description:="Validate SMTP Server Certificate", Prefix:="/")> _
